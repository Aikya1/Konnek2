package com.android.konnek2.call.core.qb.helpers;
...
public class QBCallChatHelper extends BaseHelper {
    ...
    public void init(QBChatService qbChatService) {
        ...
        Log.d("AVCALLFUNCATION", " QBCallChatHelper0 init ");
    ...
    public void initCurrentSession(QBRTCSession qbRtcSession, QBRTCSignalingCallback qbRtcSignalingCallback,
        ...
        Log.d("AVCALLFUNCATION", " QBCallChatHelper3 initCurrentSession ");
    ...
    public void initCurrentSession(QBRTCSignalingCallback qbRtcSignalingCallback,
                                   QBRTCSessionConnectionCallbacks qbRtcSessionConnectionCallbacks) {
        Log.d("AVCALLFUNCATION", " QBCallChatHelper4 initCurrentSession ");
    ...
    public void releaseCurrentSession(QBRTCSignalingCallback qbRtcSignalingCallback,
                                      QBRTCSessionConnectionCallbacks qbRtcSessionConnectionCallbacks) {
        Log.d("AVCALLFUNCATION", " QBCallChatHelper5 releaseCurrentSession ");
    ...
    private void setUpCallClient() {
        ...
        Log.d("AVCALLFUNCATION", " QBCallChatHelper6 setUpCallClient ");
    ...
    private void startCallActivity(QBRTCSession qbRtcSession) {
        ...
        Log.d("AVCALLFUNCATION", " QBCallChatHelper7 startCallActivity ");
    ...
    public void addRTCSessionUserCallback(QBRTCClientSessionCallbacks qbRtcClientSessionCallbacks) {
        Log.d("AVCALLFUNCATION", " QBCallChatHelper8 addRTCSessionUserCallback ");
        this.qbRtcClientSessionCallbacks = qbRtcClientSessionCallbacks;
    }

    public void removeRTCSessionUserCallback() {
        Log.d("AVCALLFUNCATION", " QBCallChatHelper9 removeRTCSessionUserCallback ");
    ...
    private class QBRTCClientSessionCallbacksImpl implements QBRTCClientSessionCallbacks {
        ...
        public void onReceiveNewSession(QBRTCSession qbRtcSession) {
            ...
            Log.d("AVCALLFUNCATION", " QBCallChatHelper11 QBRTCClientSessionCallbacksImpl onReceiveNewSession  ");
        ...
        public void onUserNotAnswer(QBRTCSession qbRtcSession, Integer integer) {
            ...
            Log.d("AVCALLFUNCATION", " QBCallChatHelper12 onUserNotAnswer ");
        ...
        public void onCallRejectByUser(QBRTCSession qbRtcSession, Integer integer, Map<String, String> map) {
            ...
            Log.d("AVCALLFUNCATION", " QBCallChatHelper13 onCallRejectByUser ");
        ...
        public void onCallAcceptByUser(QBRTCSession qbRtcSession, Integer integer, Map<String, String> map) {
            Log.d("AVCALLFUNCATION", " QBCallChatHelper14 onCallAcceptByUser ");
        ...
        public void onReceiveHangUpFromUser(QBRTCSession qbrtcSession, Integer integer, Map<String, String> map) {
            Log.d("AVCALLFUNCATION", " QBCallChatHelper15 onReceiveHangUpFromUser ");
        ...
        public void onUserNoActions(QBRTCSession qbRtcSession, Integer integer) {
            Log.d("AVCALLFUNCATION", " QBCallChatHelper16 onUserNoActions ");
        ...
        public void onSessionClosed(QBRTCSession qbRtcSession) {
            ...
            Log.d("AVCALLFUNCATION", " QBCallChatHelper17 onSessionClosed ");
        ...
        public void onSessionStartClose(QBRTCSession qbRtcSession) {
            ...
            Log.d("AVCALLFUNCATION", " QBCallChatHelper18 onSessionStartClose ");
