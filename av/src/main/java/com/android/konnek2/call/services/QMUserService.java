...
import com.android.konnek2.call.services.cache.QMUserMemoryCache;
...
//      }
    ...
    public Observable<List<QMUser>> getUserByTag(final String tag, final QBPagedRequestBuilder requestBuilder, boolean forceLoad) {
        return getUsersByColumn(QMUserColumns.TAGS, tag, requestBuilder, forceLoad);
    }
    ...
    private Performer<ArrayList<QBUser>> getUsersByColumnFromServer(String column, Collection<String> values, QBPagedRequestBuilder requestBuilder) {
        ...
        switch (column) {
            ...
            case QMUserColumns.TAGS:
                ...
                result = QBUsers.getUsersByTags(values, requestBuilder);
                break;
            case QMUserColumns.PASSWORD:
                result = null;
                break;
