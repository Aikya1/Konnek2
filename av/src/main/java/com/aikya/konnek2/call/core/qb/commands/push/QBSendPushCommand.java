...
public class QBSendPushCommand extends ServiceCommand {
    ...
    protected Bundle perform(Bundle extras) throws Exception {
        ...
        try {
            QBEvent event = QBPushNotifications.createEvent(pushEvent).perform();

            params.putString(ConstsCore.PUSH_MESSAGE, message);
            params.putSerializable(ConstsCore.EVENT, event);
