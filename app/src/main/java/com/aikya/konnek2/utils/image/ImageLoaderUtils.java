...
public class ImageLoaderUtils {
    ...
    public static final DisplayImageOptions UIL_USER_AVATAR_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            .showImageOnLoading(com.aikya.konnek2.R.drawable.placeholder_user).showImageForEmptyUri(com.aikya.konnek2.R.drawable.placeholder_user)
            .showImageOnFail(com.aikya.konnek2.R.drawable.placeholder_user).cacheOnDisc(true).cacheInMemory(true).build();

    public static final DisplayImageOptions UIL_GROUP_AVATAR_DISPLAY_OPTIONS = new DisplayImageOptions.Builder()
            .showImageOnLoading(com.aikya.konnek2.R.drawable.placeholder_group).showImageForEmptyUri(
                    com.aikya.konnek2.R.drawable.placeholder_group).showImageOnFail(com.aikya.konnek2.R.drawable.placeholder_group).cacheOnDisc(
    ...
    public static class SmartUriDecoder implements ImageDecoder {
        ...
        private void addVideoIcon(Bitmap source) {
            ...
            Bitmap icon = BitmapFactory
                    .decodeResource(context.get().getResources(), com.aikya.konnek2.R.drawable.ic_play_video_dark);
