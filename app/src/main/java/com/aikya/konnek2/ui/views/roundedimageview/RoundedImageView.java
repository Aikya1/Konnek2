package com.aikya.konnek2.ui.views.roundedimageview;
...
public class RoundedImageView extends AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.aikya.konnek2.R.styleable.RoundedImageView, defStyle, 0);

        int index = a.getInt(com.aikya.konnek2.R.styleable.RoundedImageView_android_scaleType, -1);
        if (index >= 0) {
        ...
        cornerRadius = a.getDimensionPixelSize(com.aikya.konnek2.R.styleable.RoundedImageView_corner_radius, -1);
        borderWidth = a.getDimensionPixelSize(com.aikya.konnek2.R.styleable.RoundedImageView_border_width, -1);
        ...
        borderColor = a.getColorStateList(com.aikya.konnek2.R.styleable.RoundedImageView_border_color);
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mutateBackground = a.getBoolean(com.aikya.konnek2.R.styleable.RoundedImageView_mutate_background, false);
        isOval = a.getBoolean(com.aikya.konnek2.R.styleable.RoundedImageView_oval, false);
