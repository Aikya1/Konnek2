package com.aikya.konnek2.ui.activities.invitefriends;
...
import com.aikya.konnek2.ui.adapters.invitefriends.InviteFriendsAdapter;
...
public class InviteFriendsActivity extends BaseLoggableActivity implements CounterChangedListener {
    ...
    @Bind(com.aikya.konnek2.R.id.friends_listview)
    ...
    protected int getContentResId() {
        return com.aikya.konnek2.R.layout.activity_invite_friends;
    }
    ...
    private void initFields() {
        title = getString(com.aikya.konnek2.R.string.invite_friends_title);
...
//        friendsContactsList = EmailHelper.getMobileContacts(this);
    ...
    private void performActionNext() {
        ...
        if (selectedContactsFriendsArray.length > ConstsCore.ZERO_INT_VALUE) {
            ...
            ToastUtils.longToast(com.aikya.konnek2.R.string.dlg_no_friends_selected);
        }
...
//        EmailHelper.sendInviteSMS(this, selectedContactsFriendsArray);
    }
    ...
    private class ActionModeCallback extends SimpleActionModeCallback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            actionMode.getMenuInflater().inflate(com.aikya.konnek2.R.menu.invite_friends_menu, menu);
            return true;
        }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case com.aikya.konnek2.R.id.action_send:
                    if (checkNetworkAvailableWithError()) {
                        performActionNext();
                        actionMode.finish();
                    }
                    return true;
                case com.aikya.konnek2.R.id.action_select_all:
                    checkAllContacts();
                    return true;
            }
    ...
    private void showPermissionSettingsDialog() {
        DialogsUtils.showOpenAppSettingsDialog(
                ...
                getString(com.aikya.konnek2.R.string.dlg_need_permission_read_contacts, getString(com.aikya.konnek2.R.string.app_name)),
