...
import com.aikya.konnek2.ui.adapters.chats.GroupDialogParticipantsAdapter;
...
import com.aikya.konnek2.call.core.models.ParcelableQBDialog;
import com.aikya.konnek2.call.core.qb.commands.chat.QBLoadDialogByIdsCommand;
...
import com.aikya.konnek2.utils.listeners.simple.SimpleActionModeCallback;
...
public class GroupDialogDetailsActivity extends BaseLoggableActivity implements
    ...
    @Bind(com.aikya.konnek2.R.id.occupants_listview)
...
//    private GroupDialogOccupantsAdapter groupDialogOccupantsAdapter;
    ...
    protected int getContentResId() {
        return com.aikya.konnek2.R.layout.activity_group_dialog_details_1;
    }
    ...
    @OnClick(com.aikya.konnek2.R.id.addParticipantTv)
...
//        groupDialogOccupantsAdapter.notifyDataSetChanged();
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menuInflater.inflate(com.aikya.konnek2.R.menu.dialog_group_remove_user_ctx_menu, menu);
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.aikya.konnek2.R.id.action_delete:
...
//        groupNameEditText.setText(qbDialog.getName());
    ...
    private void showLeaveGroupDialog() {
        TwoButtonsDialogFragment.show(getSupportFragmentManager(), com.aikya.konnek2.R.string.dlg_leave_group,
                com.aikya.konnek2.R.string.dlg_confirm, new MaterialDialog.ButtonCallback() {
                    @Override
...
//        groupNameCurrent = groupNameEditText.getText().toString();
    ...
    private void saveChanges() {
        if (!isUserDataCorrect()) {
            ToastUtils.longToast(com.aikya.konnek2.R.string.dialog_details_name_not_entered);
            return;
        }
...
//        groupNameEditText.setText(groupNameOld);
    ...
    private void addToFriendList(final int userId) {
        if (isChatInitializedAndUserLoggedIn()) {
            ...
            ToastUtils.longToast(com.aikya.konnek2.R.string.chat_service_is_initializing);
        }
    }
    ...
    private class ActionModeCallback extends SimpleActionModeCallback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            actionMode.getMenuInflater().inflate(com.aikya.konnek2.R.menu.done_menu, menu);
            return true;
        }
