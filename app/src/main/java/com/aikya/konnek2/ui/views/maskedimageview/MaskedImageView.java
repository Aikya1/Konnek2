package com.aikya.konnek2.ui.views.maskedimageview;
...
public class MaskedImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(AttributeSet attrs) {
        maskResourceId = -1;
        TypedArray array = getContext().getTheme().obtainStyledAttributes(attrs, com.aikya.konnek2.R.styleable.MaskedImageView,
                ConstsCore.ZERO_INT_VALUE, ConstsCore.ZERO_INT_VALUE);

        try {
            maskResourceId = array.getResourceId(com.aikya.konnek2.R.styleable.MaskedImageView_mask, -1);
        } finally {
            array.recycle();
        }
