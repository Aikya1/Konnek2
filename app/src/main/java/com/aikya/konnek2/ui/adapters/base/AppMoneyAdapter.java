...
public class AppMoneyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(com.aikya.konnek2.R.layout.item_money, null);
            TextView textView = grid.findViewById(com.aikya.konnek2.R.id.grid_moneytext);
            ImageView imageView = grid.findViewById(com.aikya.konnek2.R.id.grid_moneyimage);
