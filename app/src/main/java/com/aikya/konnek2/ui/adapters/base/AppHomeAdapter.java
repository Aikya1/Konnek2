...
public class AppHomeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(com.aikya.konnek2.R.layout.item_home_grid, null);
            TextView textView = grid.findViewById(com.aikya.konnek2.R.id.grid_text);
            TextView textView2 = grid.findViewById(com.aikya.konnek2.R.id.grid_text2);
            ImageView imageView = grid.findViewById(com.aikya.konnek2.R.id.grid_image);
            LinearLayout grid_home = grid.findViewById(com.aikya.konnek2.R.id.grid_home);
