...
import com.aikya.konnek2.ui.adapters.search.GlobalSearchAdapter;
import com.aikya.konnek2.ui.fragments.base.BaseFragment;
import com.aikya.konnek2.ui.fragments.dialogs.base.OneButtonDialogFragment;
...
public class GlobalSearchFragment extends BaseFragment implements SearchListener, SwipyRefreshLayout.OnRefreshListener {
    ...
    @Bind(com.aikya.konnek2.R.id.contacts_swipyrefreshlayout)
    SwipyRefreshLayout swipyRefreshLayout;

    @Bind(com.aikya.konnek2.R.id.contacts_recyclerview)
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container, Bundle savedInstanceState) {
        View view = layoutInflater.inflate(com.aikya.konnek2.R.layout.fragment_global_search, container, false);
    ...
    @OnTouch(com.aikya.konnek2.R.id.contacts_recyclerview)
...
//
    ...
    private boolean checkSearchDataWithError(String searchQuery) {
        ...
        if (correct) {
            ...
            OneButtonDialogFragment.show(getChildFragmentManager(), com.aikya.konnek2.R.string.search_at_last_items, true);
            return false;
        }
    }
    ...
    private class FindUserFailAction implements Command {
        @Override
        public void execute(Bundle bundle) {
            OneButtonDialogFragment.show(getChildFragmentManager(), com.aikya.konnek2.R.string.search_users_not_found, true);
            usersList.clear();
